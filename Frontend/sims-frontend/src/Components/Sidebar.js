      ...
      <nav className="flex flex-col p-6 space-y-6 text-lg font-bold">
        ...
        {isManagingDirector && (
          <div className="space-y-2">
            <NavLink to="/PORequest" className={navStyle}><span className="mr-2">✅</span> Purchase Order Request</NavLink>
            <NavLink to="/orderapproval" className={navStyle}><span className="mr-2">✅</span> Purchase Order Approval</NavLink>
            <NavLink to="/issueoutApproval" className={navStyle}><span className="mr-2">📤</span> Issue Out Approval</NavLink>
            <NavLink to="/VehicleFuelApproval" className={navStyle}><span className="mr-2">📤</span> Vehicle Fuel Approval</NavLink>
            <NavLink to="/EmployeeApproval" className={navStyle}><span className="mr-2">👥</span> New Employee Approval</NavLink>
          </div>
        )}
        ...
        {isLivestockManager && (
          <div className="space-y-2">
            <NavLink to="/livestock/definition" className={navStyle}>
              <span className="mr-2">🐄</span> Livestock Definitions
            </NavLink>
          </div>
        )}

        {/* ================= REPORTS (NON-HR ONLY) ================= */}
        {(isStoreManager || isManagingDirector || isAccountsManager) && (
          <div>
            <button
            ...
            {reportsOpen && (
              <div className="ml-4 mt-2 space-y-2 text-base">
                <NavLink to="/General/reports" className={navStyle}><span className="mr-2">📋</span> Inventory Reports</NavLink>
                <NavLink to="/inventory/stock" className={navStyle}><span className="mr-2">📋</span> Stock Balance</NavLink>
                <NavLink to="/reports/write" className={navStyle}><span className="mr-2">📝</span> Write Reports</NavLink>
              </div>
            )}
          </div>
        )}
        ...
        {/* ================= NOTIFICATIONS ================= */}
        <NavLink to="/Notifications" className={navStyle}><span className="mr-2">🔔</span> Notifications</NavLink>
